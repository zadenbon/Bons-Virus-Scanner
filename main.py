# Bon's Antivirus - Created by Bon
...
def scan_url(url):
    ...
    if "data" not in data:
        print("❌ Error from VirusTotal - check your API key!")
        return

    result_id = data["data"]["id"]
    print("Results may take a few seconds...")
    time.sleep(15)
    ...
    if malicious > 0:
        print("⚠️  WARNING: This URL may be dangerous!")
    else:
